...
cls
echo.
echo.SSLHELPER - BATCH SCRIPT FOR SSL CONVERSION AND GENERATION.
echo.
echo.%*
echo.
...
echo.    This script converts SSL certificates into different formarts you may need it
...
echo.    13. GENERATE SELF SIGNED
echo      GENERATE A SELF SIGNED CERTIFICATE AUTO
echo.    14. GENERATE SELF SIGNED AUTO
echo.    15. Close.
echo.
...
call :print CONVERTING PEM TO DER
...
call :print Setting up Files to be converted
call :print CONVERTING PEM TO P7B
SETLOCAL EnableDelayedExpansion
...
call :print Setting up Files to be converted
call :print CONVERTING PEM TO PFX
SETLOCAL EnableDelayedExpansion
...
openssl pkcs12 -export -out "%DateTime%.pfx" -inkey %KeyPath% -in %CertPath% -certfile "%CRTpath%"
...
call :print Setting up Files to be converted
call :print CONVERTING DER(.CRT .CER .DER) TO PEM
SETLOCAL EnableDelayedExpansion
...
call :print Setting up Files to be converted
call :print CONVERTING DER TO CER
SETLOCAL EnableDelayedExpansion
...
call :print Setting up Files to be converted
call :print CONVERTING P7B TO PEM
SETLOCAL EnableDelayedExpansion
...
:P7BPFX
call :print Setting up Files to be converted
call :print CONVERTING P7B TO PFX
SETLOCAL EnableDelayedExpansion
SET /P "P7BFile=Enter P7B file and location e.g c:\SSL\cert.p7b: "
ECHO Is this the correct File and Location !P7BFile! ?
...
call :print Setting up Files to be converted
call :print CONVERTING P7B TO CER
SETLOCAL EnableDelayedExpansion
SET /P "P7BFile=Enter P7B file and location e.g c:\SSL\cert.p7b: "
ECHO Is this the correct File and Location !P7BFile! ?
ECHO NOTE: The CER file will be dumped to the folder of this batch file
...
call :print Setting up Files to be converted
call :print CONVERTING PFX TO PEM
SETLOCAL EnableDelayedExpansion
...
:CERP7B
call :print Setting up Files to be converted
call :print CONVERTING CER TO P7B
SETLOCAL EnableDelayedExpansion
...
:CERPFX
call :print Setting up Files to be converted
call :print CONVERTING CER TO PFX
SETLOCAL EnableDelayedExpansion
SET /P "CertFileInt=Enter Intermediate cert file and location e.g c:\SSL\cert.cer: "
ECHO Is this the correct File and Location !CertFileInt! ?
SET /P "CertFileRacine=Enter CAcert file and location e.g c:\SSL\Certfile.cer: "
...
call :print Setting up Files to be converted
call :print CONVERTING CER TO DER
SETLOCAL EnableDelayedExpansion
...
:SELFSIGNED
call :print Setting up Files to be converted
call :print GENERATING A SELF SIGNED CERTIFICATE
SETLOCAL EnableDelayedExpansion
